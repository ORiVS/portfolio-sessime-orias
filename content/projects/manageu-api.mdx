...
**3) API centrale Django REST** qui porte l’ensemble de la logique métier : comptes, restaurants, menu, marketplace fournisseurs, commandes, évènements, fidélité, etc. :contentReference[oaicite:0]{index=0}
